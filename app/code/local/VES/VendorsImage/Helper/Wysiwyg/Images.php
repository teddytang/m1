 ...
 */
class VES_VendorsImage_Helper_Wysiwyg_Images extends Mage_Core_Helper_Abstract
{

	const VENDOR_IMAGE_DIRECTORY = "ves_vendors";
    /**
    ...
    public function getStorageRoot()
    {
        ...
        return Mage::getConfig()->getOptions()->getMediaDir() . DS .self::VENDOR_IMAGE_DIRECTORY. DS. Mage_Cms_Model_Wysiwyg_Config::IMAGE_DIRECTORY
            . DS."vendor".$vendor.DS;
    }
    ...
    public function getCurrentPath()
    {
        if (!$this->_currentPath) {
        	if(!is_dir($this->getStorageRoot())){
        		mkdir($this->getStorageRoot());
        	}
