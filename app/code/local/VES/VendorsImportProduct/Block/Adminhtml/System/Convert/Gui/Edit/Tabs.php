...
class VES_VendorsImportProduct_Block_Adminhtml_System_Convert_Gui_Edit_Tabs extends Mage_Adminhtml_Block_System_Convert_Gui_Edit_Tabs
{
	protected function _beforeToHtml()
    {
        $profile = Mage::registry('current_convert_profile');

        $wizardBlock = $this->getLayout()->createBlock('vendorsimport/adminhtml_system_convert_gui_edit_tab_wizard');
        ...
        if (!$new) {
			...
			*/
            ...
            $this->addTab('history', array(
                ...
                'content'   => $this->getLayout()->createBlock('vendorsimport/adminhtml_system_convert_gui_edit_tab_history')->toHtml(),
            ));
        }
