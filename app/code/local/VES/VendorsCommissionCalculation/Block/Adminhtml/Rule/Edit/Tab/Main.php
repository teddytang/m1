<?php
class VES_VendorsCommissionCalculation_Block_Adminhtml_Rule_Edit_Tab_Main
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('vendor_group_ids', 'multiselect', array(
            'name'      => 'vendor_group_ids[]',
            'label'     => Mage::helper('catalogrule')->__('Vendor Groups'),
            'title'     => Mage::helper('catalogrule')->__('Vendor Groups'),
            'required'  => true,
