...
class VES_VendorsDashboard_Block_Vendor_Dashboard_Tab_Products_Ordered extends Mage_Adminhtml_Block_Dashboard_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getResourceModel('sales/report_bestsellers_collection')
            ...
            ->addStoreFilter($storeId)->addAttributeToFilter('vendor_id',$vendorId)
        ;
